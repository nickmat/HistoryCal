...
Cal::ScriptModule Cal::cal_default_scripts[] = {
 ...
 "format cdmy \"(CDay:frcomp) |(MDay) |(NMonth:frm) |(Year)\";\n"
 "format out \"(CDay:frcomp) |(MDay) |(NMonth:frm) |(Year::rn)\";\n"
 "format dcdmy \"(DecDay:frdd) |(CDay:frcomp) |(MDay) |(NMonth:frm) |(Year)\";\n"
 "format wcdmy \"(WDay:w), |(CDay:frcomp) |(MDay) |(NMonth:frm) |(Year)\";\n"
 "format \"cdmy-\" \"(CDay:frcomp:a) |(MDay) |(NMonth:frm:a) |(Year)\";\n"
 "format \"dcdmy-\" \"(DecDay:frdd:a) |(CDay:frcomp:a) |(MDay) |(NMonth:frm:a) |(Year)\";\n"
 "format \"wcdmy-\" \"(WDay:w:a), |(CDay:frcomp:a) |(MDay) |(NMonth:frm:a) |(Year)\";\n"
 "pref cdmy;\n"
 "}\n"
 "scheme fr {\n"
