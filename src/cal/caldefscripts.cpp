...
const char* Cal::cal_default_scripts[] = {
 ...
 "tokens {\n"
 "1, \"D\303\251cade I\",   \"Dec I\";\n"
 "2, \"D\303\251cade II\",  \"Dec II\";\n"
 "3, \"D\303\251cade III\", \"Dec III\";\n"
 "}\n"
 "}\n"
 "vocab \"frdd\" {\n"
 "name \"Decade Day\";\n"
 ...
 "format \"mdy\",   \"@(Month:frm) @(Day), @(Year)\";\n"
 "format \"ymd\",   \"@(Year)@,(Month:frm.a)@,(Day)\";\n"
 "format \"dwmy\",  \"@(CompDay:frcomp) @(Decade:frdim), @(DecDay:frdd), @(NMonth:frm) @(Year)\";\n"
 "pref \"cdmy\";\n"
 "}\n"
 "scheme \"fr\" {\n"
