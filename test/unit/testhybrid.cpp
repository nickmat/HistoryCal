...
void TestHybrid::testOverlap()
{
    struct data { string in; string out; } t[] = {
        { "1752 9 2", "1752 9 2 0" },
        { "1752 9 3", "1752 9 3 0 | 1752 9 3 1" },
        { "1752 9 13", "1752 9 13 0 | 1752 9 13 1" },
        { "1752 9 14", "1752 9 14 1" },
        { "1752 9", "1752 9 1 0 .. 1752 9 30 1" },
    };
...
{
    struct data { string in; string out; } t[] = {
        { "1750 12 31", "1750 12 31 0" },
        { "1751 1 1", "1751 1 1 0 | 1751 1 1 1" },
        { "1751 3 24", "1751 3 24 0 | 1751 3 24 1" },
        { "1751 3 25", "1751 3 25 0" },
        { "1751 12 31", "1751 12 31 0" },
        { "1752 1 1", "1752 1 1 1" },
        { "1751", "1751 1 1 0 .. 1751 3 24 1" },
        { "1751 2", "1751 2 1 0 .. 1751 2 28 0 | 1751 2 1 1 .. 1751 2 29 1" },
    };
    size_t count = sizeof(t) / sizeof(data);
